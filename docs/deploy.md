...
git clone https://gitlab.semeg.oriximina.pa.gov.br/sistemas/sigsis.git
cd sigsis
...
mysql -u root -p sigsis_db < ../database/schema.sql
mysql -u root -p sigsis_db < ../database/seeds.sql
